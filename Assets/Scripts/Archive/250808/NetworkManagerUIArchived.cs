// Script from 250804 
// Attempts to implement both Unity Relay and a port forwarding connection
// As only Relay is currently used, I've moved this to Archive
...
public class NetworkManagerUIArchived : NetworkBehaviour
{
    ...
    // N.B. that only the Relay-relevant code is used currently. This does not 
    // require any information about IP addresses or ports for port forwarding
    private void Awake()
    {
        ...
        hostButton.onClick.AddListener(async () =>
        {
            ...
            {
                Debug.Log("Port string is null or empty. Using default port");
            ...
            {
                // Set port as default or user input value
