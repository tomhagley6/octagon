...
public class TrialLogicExtension : MonoBehaviour
{
    ...
    {
        // changed to be handled globally such that all octagons have the same walls
    ...
    public void ColourWalls(int wallID1, int wallID2, string thisTrialType)
    {
        ...
        switch (thisTrialType)
        {
            ...
            // remove risky choice for first runs to learn basic reward structure
